...
const allowedOrigins = ['https://v6p9d9t4.ssl.hwcdn.net', 'https://serve.gamejolt.net'];
  const origin = req.headers.origin;
  if (allowedOrigins.includes(origin)) {
    // Erlaubte Domain, fortsetzen
  } else {
    ws.close();
    console.log(`Verbindung von nicht autorisiertem Ursprung ${origin} geschlossen`);
  }
